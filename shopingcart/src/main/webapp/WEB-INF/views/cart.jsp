			...
			<table id="cart" class="table table-hover table-condensed">
					...
					<c:forEach items="${cartLines}" var="cartLine">
						...
						<tr>
							...
							<td data-th="Quantity">
								<input type="number" id="count_${cartLine.id}" min="1" class="form-control text-center" value="${cartLine.productCount}">
							</td>
							<td data-th="Subtotal" class="text-center">&#8377; ${cartLine.total}</td>
							<td class="actions" data-th="">
								<button type="button" name="refreshCart" value="${cartLine.id}" class="btn btn-info btn-sm"><span class="fa fa-sync"></span></button>
								<a href="${contextRoot}/cart/${cartLine.id}/delete" class="btn btn-danger btn-sm"><span class="far fa-trash-alt"></span></a>								
							</td>
						</tr>
					</tbody>
					...
					<tfoot>
						...
						<tr>
							<td><a href="${contextRoot}/show/all/products" class="btn btn-warning"><span class="fa fa-angle-left"></span> Continue Shopping</a></td>
